"""Export the AgentSpec JSON Schema for the web client to consume.
    ...
    python -m veldra_spec.export_schema [out_path]
...
from veldra_spec.models import AgentSpec
...
def _default_out() -> Path:
    # packages/spec-schema/veldra_spec/export_schema.py -> repo root is parents[3]
