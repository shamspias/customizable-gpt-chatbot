...
Defined here as a leaf (depends only on loom_mcp); the actual retrieval function
is dependency-injected by loom_app so this package doesn't import the service.
